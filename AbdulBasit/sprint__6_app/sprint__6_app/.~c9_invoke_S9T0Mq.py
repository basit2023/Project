...
class StepStage(Stage):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        step_stage_ECR=ECR_stack(self, "BasitstepstageECRstack",env=cdk.Environment(account='315997497220', region='us-east-2'))
        step_stage_ECR=ECS_stack(self, "BasitstepstageECSstack", repo=step_stage_ECR.ecr_repositry,env=cdk.Environment(account='315997497220', region='us-east-2'))
